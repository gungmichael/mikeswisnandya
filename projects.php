...
<head>
    ...
    <title>Projects - Mike Swisnandya</title>
...
<body>
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-md-end" href="/">
        ...
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p class="text-muted w-lg-50">The following are projects that I have been working on for some time</p>
                </div>
            </div>
