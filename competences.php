...
<head>
    ...
    <title>Competences - Mike Swisnandya</title>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="competences.php">Competences</a></li>
        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Competences</p>
                    <h3 class="fw-bold">What we can do for you</h3>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                <div class="col mb-5"><img class="rounded img-fluid shadow" src="assets/img/products/1_1.jpg"></div>
                <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div>
                        <h5 class="fw-bold">Photographer</h5>
                        <p class="text-muted mb-4">I have been in the field of photography for the last 6 years, many portfolios that I have produced during this time.<br></p>
                        <button class="btn btn-primary shadow" style="color: white;" type="button"><a href="https://www.instagram.com/gungmichael" target="_blank">Learn more</a></button>
                    </div>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                <div class="col order-md-last mb-5"><img class="rounded img-fluid shadow" src="assets/img/products/3_1.jpg"></div>
                <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div>
                        <h5 class="fw-bold">Videographer</h5>
                        <p class="text-muted mb-4">It's just a hobby, but often accepts videography offers when asked by clients.<br></p>
                        <button class="btn btn-primary shadow" type="button">Learn more</li></button>
                    </div>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                <div class="col mb-5"><img class="rounded img-fluid shadow" src="assets/img/products/brektortundks.jpeg"></div>
                <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div>
                        <h5 class="fw-bold">Graphic Designer</h5>
                        <p class="text-muted mb-4">My taste in design prioritizes layout composition accompanied by aesthetics in order to give an impression to the reader.<br></p>
