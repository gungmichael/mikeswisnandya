...
<head>
    ...
    <title>Services - Mike Swisnandya</title>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="competences.html">Competences</a></li>
            ...
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
                ...
                <div class="col d-md-flex align-items-md-end align-items-lg-center mb-5">
                    <div>
                        ...
                        <button class="btn btn-primary shadow" style="color: white;" type="button"><a href="https://www.instagram.com/gungmichael" target="_blank">Learn more</button>
                    </div>
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 mx-auto" style="max-width: 900px;">
